...
supported claim.
Longer-budget P1$+$P2 remains exploratory: the current reduced A10G scouts
validate the robustness of Phase~1, while the current Qwen follow-up indicates
that long-budget P1$+$P2 is not yet stable enough to support the main claim.
...
scale-up hypothesis rather than a validated core claim, and the current Qwen
follow-up suggests that this longer-budget path may require debugging before it
belongs in the main story at all.
...
treated as durable; the longer-budget Qwen follow-up currently points in the
opposite direction for P1$+$P2.
